...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        ...
        <li class="layui-nav-item to-index">
            <a href="${pageContext.request.contextPath}/sys/logout.html">前台首页</a></li>
    </ul>
</div>
<!-- 顶部结束 -->
<!-- 中部开始 -->
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='userstatics/welcome1.html' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
